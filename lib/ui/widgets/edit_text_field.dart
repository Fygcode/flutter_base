...
TextStyle _errorTextStyle = AppTextStyle.button
    .copyWith(color: AppColor.error, fontSize: 12, fontWeight: FontWeight.w500,);
TextStyle _labelTextStyle = AppTextStyle.button
    .copyWith(fontSize: 12, fontWeight: FontWeight.w500, color: Colors.black);
TextStyle _bodyTextStyle = AppTextStyle.button.copyWith(color: AppColor.black);
TextStyle _hintTextStyle = AppTextStyle.button.copyWith(
    color: AppColor.outline, fontSize: 14, fontWeight: FontWeight.w500);
                              ...
                              widget.subTitle == null
                                  ...
                                  : Padding(
                                      ...
                                      child: Text("${widget.subTitle}",
                                          style: AppTextStyle.authText.copyWith(
                                            fontSize: 12,
                  ...
                  child: TextField(
                      ...
                      decoration: InputDecoration(
                        fillColor: !widget.enabled
                            ? AppColor.white
                            : isFocused
                                ? AppColor.textOnError
                                : Colors.white,
                        filled: true,
                        contentPadding: widget.padding ??
                            const EdgeInsets.only(
                                top: 14, left: 12, right: 12, bottom: 9),
                        ...
                        prefixIconConstraints:
                            const BoxConstraints(minWidth: 15, maxHeight: 24),
  ...
  Widget _buildPasswordEyeIcon() {
    return IconButton(
        ...
        icon: SvgPicture.asset(
          isVisible ? Images.passShow : Images.passHidden,
          height: 18,
          width: 18,
        ),
        onPressed: () {
