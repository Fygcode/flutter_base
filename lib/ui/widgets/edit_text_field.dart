...
//
//
// TextStyle _errorTextStyle = AppTextStyle.button.copyWith(color: AppColor.error, fontSize: 12, fontWeight: FontWeight.w500);
// TextStyle _labelTextStyle = AppTextStyle.button.copyWith(fontSize: 12, fontWeight: FontWeight.w500);
// TextStyle _bodyTextStyle = AppTextStyle.button;
// TextStyle _hintTextStyle = AppTextStyle.button.copyWith(color: AppColor.outline, fontSize: 14, fontWeight: FontWeight.w500);
//
...
//                                 child: Text("${widget.subTitle}",style: AppTextStyle.authText.copyWith(fontSize:12,color:AppColor.primary)),
//                               ),
...
//                       // inputFormatters: widget.isPasswordField || widget.controller.textInputType == TextInputType.emailAddress || widget.noSpace == true ? [
...
//                         filled: true,
//                         contentPadding: widget.padding ?? const EdgeInsets.only(top: 14, left: 12,right: 12,bottom: 9),
